...
$s="SELECT * FROM vehicle_details where vul_id=$l_id";
//var_dump($s);
      if(!$stmt=mysqli_query($con,$s))
      {
  ...
  $v_name=$row['v_name'];
   ...
   // $pincode=$row['p_pincode'];
    ...
    <td><img src="images/<?php echo $v_rc;?>" width="100px" height="100px"></td>
                                    ...
                                    <td><a href="editv.php?vul_id=<?php echo $vul_id;?>&v_id=<?php echo $v_id;?>"><button class="btn btn-success" >Edit</button></a></td>
                                    
                                    <td><a href="deletev.php?vul_id=<?php echo $vul_id;?>&v_id=<?php echo $v_id;?>"><button class="btn btn-danger" >Delete</button></a></td>
                                      <td><a href="modified.php?vul_id=<?php echo $vul_id;?>&v_id=<?php echo $v_id;?>"><button class="btn btn-primary" >Modify</button></a></td>
