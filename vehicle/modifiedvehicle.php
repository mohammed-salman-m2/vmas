...
if(isset($_POST['submit']))
{
  ...
  $qu="UPDATE modified SET m_image='$image' where m_id=$m_id";
  var_dump($qu);
 ...
 $result1=$con->query($qu);
  ...
  //echo "<script>window.location.replace('viewsubjecten.php');</script>";
   ...
   echo "<script>
    window.location.replace('approvedm.php')
    </script>";
    }
...
?>
  ...
  Upload your Images Here...
   <img width="20%" height="40%" src="images/<?php echo $result['m_image'];?>">
          <input placeholder="Image" name="image" type="file"  value="<?php echo $result['m_image'];?>">
                        <input type="hidden" name="image1" value="<?php echo $result['m_image'];?>" >
